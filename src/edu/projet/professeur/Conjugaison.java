...
public class Conjugaison {
	 ...
	 * @param question                  l'entrée utilisateur est formatée de façon à
	 *                                  améliorer la formulation exemple : tu -->
	 *                                  vous pk --> pourquoi etc ... voir fichier
	 *                                  "conjugaison-traduction.csv".
	 * 
	 ...
	 *         suis perdu Professeur match (je suis perdu) -> traitement (vous êtes
	 *         perdu) réponse: Pourqoui pensez-vous que (vous êtes perdu) voir
	...
	static String conjuger(String question, String cheminFichierDeTraitement) {
		...
		/*
		 * on décompose l'entrée utilisateur en mots exemple : Je voudrais savoir ... ->
		 * [je, voudrais, savoir, ..]
		 * 
		 */
		 ...
		 * cheminFichierDeTraitement en entrée "conjugaison-traduction.csv" en sortie
		 * "sujet-objet.csv"
		 * 
		 */
		...
		System.out.println("class Conjugaison:Conjugaison.conjuger(" + question + "," + cheminFichierDeTraitement + ")="
				+ question);
		return question;
	}
	...
	static String orthographe(String reponse) {
		...
		System.out.println("class Conjugaison:Conjugaison.orthographe(" + reponse + "=" + reponse);
		return reponse;
	}
