...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("> Professeur : " + Professeur.reponse(question, "abarti"));

		/*
		 * ProfBot bot = new ProfBot("LeProfesseur"); String serveur = null, canal;
		 * 
		 * try { if ( args.length == 2) { serveur = args[0]; canal = args[1]; } else {
		 * System.out.println("Usage: server channel");
		 * System.out.println("Connexion au serveur et au canal par défaut."); serveur =
		 * "michel-bakhtaoui.fr"; canal = "#ircprojet"; }
		 * 
		 * // Enable debugging output. bot.setVerbose(true);
		 * 
		 * // Connect to the IRC server. bot.connect(serveur);
		 * 
